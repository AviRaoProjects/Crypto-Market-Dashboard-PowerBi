...
- Analyze high/low and open/close price fluctuations.  
- Study trading volume, yearly trends, and volatility patterns.  
- Build an interactive dashboard with KPI cards, slicers, and navigation buttons.  
- Present insights with a modern, clean UI theme.  

**Dataset Information**

The dataset includes:  
- Crypto Details → Name, Symbol, Category  
- Market Metrics → Market Cap, Volume, Open Price, Close Price  
- Price Data → High, Low, Date-wise performance  
- Filters → Year, Crypto Category  
...
- Significant volatility observed in open vs close pricing.  
- High trading volume correlates with price fluctuations.  
